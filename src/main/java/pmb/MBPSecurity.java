package pmb;
	...
	@ManagedBean(name = "mbPSec")
	@SessionScoped
	public class MBPSecurity {
		...
		public String checkUser() {
			if (userName.equalsIgnoreCase("upskilling") && passWord.equals("upskilling@2022")) {
				logon = true;
				return "/p-home.xhtml";
		...
		public String logout() {
			...
			return "/p-home.xhtml?faces-redirect=true";
		}
